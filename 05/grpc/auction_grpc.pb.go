...
type AuctionClient interface {
	...
	Replicate(ctx context.Context, in *ReplicaMsg, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *auctionClient) Replicate(ctx context.Context, in *ReplicaMsg, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
type AuctionServer interface {
	...
	Replicate(context.Context, *ReplicaMsg) (*Ack, error)
...
func (UnimplementedAuctionServer) Replicate(context.Context, *ReplicaMsg) (*Ack, error) {
...
func _Auction_Replicate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServer).Replicate(ctx, req.(*ReplicaMsg))
	}
	return interceptor(ctx, in, info, handler)
}
